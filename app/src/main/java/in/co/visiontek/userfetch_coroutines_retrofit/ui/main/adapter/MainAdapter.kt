package `in`.co.visiontek.userfetch_coroutines_retrofit.ui.main.adapter

import `in`.co.visiontek.userfetch_coroutines_retrofit.databinding.ItemLayoutBinding
